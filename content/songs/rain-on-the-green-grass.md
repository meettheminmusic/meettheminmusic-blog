...
abc_notation: |-
  ...
  %%barsperstaff 4
  K:C
  V:1 clef=perc stafflines=1name="" snm=""
  V:2 clef=perc stafflines=1 name="Wood" snm="W"
  V:3 clef=perc stafflines=1 name="Drum" snm="D"
  V:1
  A2 AA |A2 A2 |A2 AA |A2z2 ||
  w: Rain on the green grass, rain on the tree.
  M: 2/4
  A2 AA |A2 A2 |A2 A2 |A2 A2 |]
  w: Rain on the roof top. Not on me!
  V:2
