...
{{< callout title="Nudges not Control" >}}
It is tricky to talk about behavior management without feeling like we are talking about "control" and removing a student's autonomy. The goal of classroom management is to nudge students into acting in a way that will help them learn well, be present, and be part of the group. For many of our students, including those with disabilities, that means building self-regulation and inhibition.
{{< /callout >}}

***

## Understanding E.A.T.S.: the four functions of behavior
